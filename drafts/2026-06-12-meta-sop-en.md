...
EN thread, 6 tweets. Follows voice.md (builder-to-builder, no hype,
hashtags on last tweet only).
-->

1/6
I handed an AI agent the keys to my X account.
...
2/6
Core idea: the agent's operating manual is not a prompt — it's a repo.
...
3/6
Approval used to be a chat message: "looks good, go." Ambiguous, unlogged.
...
5/6
The part I like most: the SOP learns.
...
6/6
The whole system is public — SOP, scripts, safety rules. This very thread was drafted as a PR and published through that exact pipeline.
